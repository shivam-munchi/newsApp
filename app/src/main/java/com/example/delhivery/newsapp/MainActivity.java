...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    static final String API_KEY = "4e2a2149e9e945aa9ddb3a181a886546";
    ...
    private void checkForError()
    {
        ...
        Call<ErrorResp> call= apiClient.checkError(API_KEY);

        call.enqueue(new Callback<ErrorResp>() {
            @Override
            public void onResponse(Call<ErrorResp> call, Response<ErrorResp> response) {
                Toast.makeText(MainActivity.this,"Successful error",Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFailure(Call<ErrorResp> call, Throwable t) {
                Toast.makeText(MainActivity.this,"Error hi error",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void getSourcesOnCreateSourceResp()
    {
        ...
        Call<SourceResp> call= apiClient.getSourcesSourceResp(API_KEY);
